...
v1_mitigation = [40.1, 32, 33, 37, 38]
v1_32_mitigation = [40.1, 30.5, 28.4, 28.9, 30.6]
v2_mitigation = [40.1, 30.3, 29.2, 30.5, 33.0]
...
ax1.plot(steps, v1_mitigation, 's-', color=color_v1_mit, linewidth=2, markersize=6, label=r'v1 ($\lambda$=9, ReLU)')
ax1.plot(steps, v1_32_mitigation, 'D-', color=color_v1_32_mit, linewidth=2, markersize=6, label=r'v1 ($\lambda$=32, ReLU)')
ax1.plot(steps, v2_mitigation, '^-', color=color_v2_mit, linewidth=2, markersize=6, label=r'v2 ($\lambda$=8, no ReLU)')
...
ax2.plot(steps, em_v1_mitigation, 's-', color=color_v1_mit, linewidth=2, markersize=6, label=r'v1 ($\lambda$=9, ReLU)')
