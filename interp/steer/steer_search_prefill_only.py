...
class SearchTokenSteerer:
    ...
    def _hook(self, module, input):
        ...
        if self.call_count <= 3:
            ...
            print(f"      [DEBUG] Call {self.call_count}, seq_len={seq_len}, STEERING, per_token_norm={orig_norm:.1f}, steer_norm={steer_norm:.1f} ({steer_pct:.1f}%), modified_norm={modified_norm:.1f}")
