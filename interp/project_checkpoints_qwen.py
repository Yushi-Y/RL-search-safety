...
parser.add_argument("--ckpt_base", type=str,
                    default="/VData/kebl6672/ARL/verl_checkpoints/search-r1-grpo-qwen2.5-7b-it-em/actor")
parser.add_argument("--output_suffix", type=str, default="",
                    help="Suffix appended to output filenames to distinguish runs")
...
def main():
    ...
    output_file = OUTPUT_DIR / f"qwen7b_all_checkpoints_search_query_projections{suffix}.json"
    ...
    plt.tight_layout()
    plot_file = OUTPUT_DIR / f"qwen7b_all_checkpoints_search_query_projection{suffix}.png"
